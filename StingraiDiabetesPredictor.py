...
def main():
    ...
    danger_html="""
      <div style="background-color:#F08080;padding:10px >
       <h2 style="color:black ;text-align:center;"> You're at risk of developing diabetes.<br>*This is not medical advice, please consult with a medical professional.</h2>
       </div>
    """
